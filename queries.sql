SELECT fornecedor_name from fornecedor NATURAL JOIN (SELECT fornecedor_nif from produto
...
SELECT fornecedor_nif, fornecedor_name FROM produto NATURAL JOIN fornecedor GROUP BY fornecedor_nif, fornecedor_name
