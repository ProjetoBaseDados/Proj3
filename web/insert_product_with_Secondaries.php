<html>
    <body>
        ...
        <form action="insert_product_without_Secondaries_Update.php" method="post">
            ...
            <p>Fornecedor Primario NIF: <input type="text" name="fornecedor_nif" pattern="(?=.9\d).{9}"/></p>
            <p>Fornecedor Primario name: <input type="text" name="fornecedor_name"/></p>
            <p>Fornecedor Secundario NIF: <input type="text" name="fornecedor_sec_nif" pattern="(?=.9\d).{9}"/></p>
            <p>Fornecedor Secundario name: <input type="text" name="fornecedor_sec_name"/></p>
